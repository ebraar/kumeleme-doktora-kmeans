...
print("\n" + "=" * 60)
print("DATASET 3 - WHOLESALE CUSTOMERS (OPTICS)")
print("=" * 60)
...
plt.title("Reachability Plot - Dataset 3 (OPTICS)")
...
output_dir = "../../results/optics/dataset3"
os.makedirs(output_dir, exist_ok=True)

summary_path = os.path.join(output_dir, "summary-optics-dataset3.txt")

with open(summary_path, "w", encoding="utf-8") as f:
    f.write("DATASET 3 - WHOLESALE CUSTOMERS (OPTICS)\n")
    f.write("=" * 60 + "\n\n")
